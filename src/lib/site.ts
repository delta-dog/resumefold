...
const publicUrl = process.env.NEXT_PUBLIC_SITE_URL || (deploymentHost ? `https://${deploymentHost}` : "https://delta-dog.github.io/resumefold/");
const parsedUrl = new URL(publicUrl);
const publicPath = (process.env.NEXT_PUBLIC_BASE_PATH || parsedUrl.pathname).replace(/\/$/, "");
...
export const SITE = {
  ...
  url: parsedUrl.origin + publicPath,
